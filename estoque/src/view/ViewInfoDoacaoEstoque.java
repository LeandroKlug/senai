...
public class ViewInfoDoacaoEstoque extends JFrame {
	...
	public ViewInfoDoacaoEstoque() {
		...
		editar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				EstoqueDAO estoqueInserirDAO = new EstoqueDAO();
				Estoque estoque1 = estoqueInserirDAO.select(Estoque.class, Integer.parseInt(idItemDoado.getText()));
				estoque1.setNomeItem(tipoItemDoado.getText());
				estoque1.setQuantidade(qtddItem.getText());
				//estoque1.setstatus(null);
				estoqueInserirDAO.update(estoque1);
